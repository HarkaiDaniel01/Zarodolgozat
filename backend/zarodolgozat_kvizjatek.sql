...
(1, 'Melyik évben volt a nikáfelkelés?', '532', '476', '622', '800', 1, 'A bizánci történelem egyik legnagyobb lázadása.', 3),
(2, 'Ki volt a bizánci császár a nikáfelkelés idején?', 'I. Justinianus', 'I. Constantinus', 'II. Theodosius', 'Herakleiosz', 1, 'A bizánci birodalom jelentős uralkodója.', 3),
(3, 'Melyik évben volt a canossa-járás?', '1077', '1215', '800', '962', 1, 'A pápaság és császárság konfliktusának szimbóluma.', 3),
(4, 'Ki volt az első Habsburg császár?', 'I. Rudolf', 'II. Ferdinánd', 'III. Károly', 'I. Miksa', 1, 'A Habsburg-dinasztia alapítója.', 3),
(5, 'Melyik évben volt a wormsi konkordátum?', '1122', '1077', '1215', '1302', 1, 'A pápaság és császárság közötti megegyezés.', 3),
(6, 'Melyik évben volt a rigómezei csata?', '1389', '1453', '1526', '1302', 1, 'A török terjeszkedés fontos állomása.', 3),
(7, 'Ki volt a magyar király a rigómezei csata idején?', 'Zsigmond király', 'Nagy Lajos', 'Károly Róbert', 'II. Ulászló', 1, 'A Luxemburg-ház uralkodója.', 3),
(8, 'Melyik évben volt a bécsi ostrom a törökök által?', '1683', '1526', '1606', '1711', 1, 'A Habsburg-török háborúk fordulópontja.', 3),
(9, 'Ki vezette a török sereget a bécsi ostromnál?', 'Kara Musztafa', 'Szulejmán szultán', 'Mehmed', 'Selim', 1, 'A török hadvezetés kulcsfigurája.', 3),
(10, 'Melyik évben volt a harmincéves háború kezdete?', '1618', '1648', '1606', '1588', 1, 'Európa egyik leghosszabb háborúja.', 3),
(11, 'Melyik béke zárta le a harmincéves háborút?', 'Vesztfáliai béke', 'Utrechti béke', 'Trianoni béke', 'Bécsi béke', 1, 'A vallási háborúk lezárása.', 3),
(12, 'Melyik évben volt a Szent Szövetség megalakulása?', '1815', '1792', '1848', '1871', 1, 'A napóleoni háborúk utáni rend fenntartása.', 3),
(13, 'Ki volt a magyar miniszterelnök 1848-ban?', 'Batthyány Lajos', 'Kossuth Lajos', 'Széchenyi István', 'Deák Ferenc', 1, 'Az első felelős magyar kormány vezetője.', 3),
(14, 'Melyik évben volt a kiegyezés?', '1867', '1848', '1871', '1850', 1, 'A Habsburg-magyar viszony rendezése.', 3),
(15, 'Ki volt Ferenc József felesége?', 'Erzsébet királyné', 'Mária Terézia', 'Zita királyné', 'Anna királyné', 1, 'A magyarok által kedvelt uralkodóné.', 3),
(16, 'Melyik évben volt az első magyar népköztársaság?', '1918', '1946', '1920', '1919', 1, 'Az Osztrák–Magyar Monarchia bukása után.', 3),
(17, 'Ki volt az első magyar köztársasági elnök?', 'Károlyi Mihály', 'Horthy Miklós', 'Bibó István', 'Nagy Imre', 1, 'A Tanácsköztársaság előtti vezető.', 3),
(18, 'Melyik évben volt a Tanácsköztársaság?', '1919', '1918', '1920', '1945', 1, 'A kommunista hatalomátvétel rövid időszaka.', 3),
(19, 'Ki vezette a Tanácsköztársaságot?', 'Kun Béla', 'Károlyi Mihály', 'Rákosi Mátyás', 'Nagy Imre', 1, 'A kommunista vezetés alakja.', 3),
(20, 'Melyik évben volt a második bécsi döntés?', '1940', '1938', '1941', '1939', 1, 'Magyarország területi visszacsatolása.', 3),
(21, 'Melyik évben volt a doni katasztrófa?', '1943', '1941', '1944', '1942', 1, 'A magyar hadsereg súlyos vesztesége.', 3),
(22, 'Ki volt a magyar miniszterelnök a doni katasztrófa idején?', 'Kállay Miklós', 'Teleki Pál', 'Bárdossy László', 'Nagy Ferenc', 1, 'A háborús időszak politikai vezetője.', 3),
(23, 'Melyik évben volt a párizsi békeszerződés?', '1947', '1945', '1956', '1939', 1, 'A második világháború utáni rendezés.', 3),
(24, 'Melyik évben volt a magyar forradalom leverése?', '1956', '1945', '1968', '1989', 1, 'A szovjet beavatkozás éve.', 3),
(25, 'Ki volt a szovjet vezető 1956-ban?', 'Hruscsov', 'Sztálin', 'Gorbacsov', 'Lenin', 1, 'A magyar forradalom leverésének irányítója.', 3),
(26, 'Melyik évben volt a rendszerváltás Magyarországon?', '1989', '1990', '1985', '1991', 1, 'A kommunista rendszer bukása.', 3),
(27, 'Ki volt az első szabadon választott magyar miniszterelnök?', 'Antall József', 'Horn Gyula', 'Orbán Viktor', 'Németh Miklós', 1, 'A demokratikus átmenet vezetője.', 3),
(28, 'Melyik évben csatlakozott Magyarország a NATO-hoz?', '1999', '2004', '1990', '1989', 1, 'A nyugati katonai szövetséghez való csatlakozás.', 3),
(29, 'Melyik évben volt a berlini konferencia?', '1884', '1905', '1848', '1914', 1, 'A gyarmati területek felosztása Afrikában.', 3),
(30, 'Melyik évben volt a spanyol polgárháború kezdete?', '1936', '1939', '1945', '1922', 1, 'A fasizmus és kommunizmus harca.', 3),
(31, 'Ki volt a spanyol polgárháború fasiszta vezetője?', 'Franco tábornok', 'Mussolini', 'Hitler', 'Salazar', 1, 'A diktatúra megalapítója Spanyolországban.', 3),
(32, 'Melyik évben volt a müncheni egyezmény?', '1938', '1939', '1945', '1941', 1, 'A Szudéta-vidék átadása Németországnak.', 3),
(33, 'Melyik évben volt a Pearl Harbor elleni támadás?', '1941', '1939', '1945', '1942', 1, 'Az USA belépése a világháborúba.', 3),
(34, 'Melyik évben volt a normandiai partraszállás?', '1944', '1941', '1945', '1943', 1, 'A nyugati front megnyitása.', 3),
(35, 'Melyik évben volt a potsdami konferencia?', '1945', '1943', '1944', '1946', 1, 'A háború utáni rendezés.', 3),
(36, 'Melyik évben volt a vasfüggöny lebontása?', '1989', '1991', '1985', '1990', 1, 'A kelet-nyugati megosztottság vége.', 3),
(37, 'Melyik évben volt a Maastrichti szerződés?', '1992', '2004', '1999', '1989', 1, 'Az Európai Unió alapító dokumentuma.', 3),
(38, 'Melyik évben volt a 9/11 terrortámadás?', '2001', '1999', '2004', '1995', 1, 'A modern történelem egyik fordulópontja.', 3),
(39, 'Melyik évben volt az arab tavasz kezdete?', '2010', '2001', '2005', '2015', 1, 'A közel-keleti forradalmi hullám kezdete.', 3),
(40, 'Melyik évben volt a Brexit népszavazás?', '2016', '2019', '2012', '2008', 1, 'Nagy-Britannia EU-ból való kilépéséről döntöt', 3),
(41, 'Mikor volt a tatárjárás?', '1241', '1526', '1703', '1848', 1, 'A magyar történelem egyik sorsfordító eseménye.', 1),
(42, 'Ki volt az első magyar király?', 'Szent István', 'Károly Róbert', 'Hunyadi János', 'IV. Béla', 1, 'A keresztény magyar állam megalapítója.', 1),
(43, 'Melyik évben volt a mohácsi csata?', '1526', '1456', '1701', '1849', 1, 'A magyar történelem egyik legnagyobb veresége.', 1),
(44, 'Ki vezette a honfoglalást?', 'Árpád', 'Koppány', 'Géza', 'Szent István', 1, 'A magyar törzsek vezetője a honfoglalás idején.', 1),
(45, 'Melyik évben adták ki az amerikai függetlenségi nyilatkozatot?', '1776', '1789', '1804', '1755', 1, 'Az Egyesült Államok születésének dátuma.', 1),
(46, 'Ki volt a náci Németország vezetője?', 'Adolf Hitler', 'Joseph Stalin', 'Winston Churchill', 'Franklin D. Roosevelt', 1, 'A második világháború egyik fő alakja.', 1),
(47, 'Melyik évben omlott le a berlini fal?', '1989', '1991', '1975', '1961', 1, 'A hidegháború végét jelképező esemény.', 1),
(48, 'Melyik országban kezdődött a reformáció?', 'Németország', 'Franciaország', 'Olaszország', 'Anglia', 1, 'Luther Márton tevékenységéhez köthető.', 1),
(49, 'Ki volt a Római Birodalom első császára?', 'Augustus', 'Julius Caesar', 'Nero', 'Caligula', 1, 'A császári rendszer megalapítója.', 1),
(50, 'Melyik évben kezdődött az első világháború?', '1914', '1918', '1939', '1905', 1, 'A 20. század első nagy háborúja.', 1),
(51, 'Melyik évben ért véget a második világháború?', '1945', '1939', '1950', '1941', 1, 'A világháború lezárása.', 1),
(52, 'Ki volt a magyar szabadságharc vezetője 1848-ban?', 'Kossuth Lajos', 'Széchenyi István', 'Petőfi Sándor', 'Batthyány Lajos', 1, 'A forradalom politikai vezéralakja.', 1),
(53, 'Melyik évben volt a Rákóczi-szabadságharc kezdete?', '1703', '1848', '1526', '1606', 1, 'A Habsburgok elleni felkelés kezdete.', 1),
(54, 'Ki volt a náci propaganda minisztere?', 'Joseph Goebbels', 'Hermann Göring', 'Heinrich Himmler', 'Albert Speer', 1, 'A náci propaganda irányítója.', 1),
(55, 'Melyik évben lett Magyarország EU tag?', '2004', '1999', '2010', '1990', 1, 'Az európai integráció fontos lépése.', 1),
(56, 'Ki volt a Szovjetunió első vezetője?', 'Lenin', 'Stalin', 'Kruscsov', 'Gorbacsov', 1, 'A bolsevik forradalom vezéralakja.', 1),
(57, 'Melyik évben volt a párizsi béke?', '1947', '1919', '1955', '1939', 1, 'A második világháború utáni rendezés.', 1),
(58, 'Melyik országban volt a Bastille ostroma?', 'Franciaország', 'Németország', 'Olaszország', 'Anglia', 1, 'A francia forradalom kezdete.', 1),
(59, 'Melyik évben volt a 1956-os forradalom?', '1956', '1945', '1968', '1989', 1, 'A magyar népfelkelés éve.', 1),
(60, 'Ki volt a római hadvezér aki átlépte a Rubicont?', 'Julius Caesar', 'Nero', 'Augustus', 'Brutus', 1, 'A köztársaság bukásának előidézője.', 1),
(61, 'Melyik évben volt a Magna Carta kiadása?', '1215', '1066', '1492', '1302', 1, 'Az angol jog történetének mérföldköve.', 1),
(62, 'Ki volt a náci Németország hadseregének főparancsnoka?', 'Heinrich Himmler', 'Erwin Rommel', 'Adolf Hitler', 'Joseph Goebbels', 1, 'A Wehrmacht vezetője.', 1),
(63, 'Melyik évben kezdődött a hidegháború?', '1947', '1939', '1955', '1961', 1, 'A kétpólusú világ kialakulása.', 1),
(64, 'Melyik évben volt a müncheni egyezmény?', '1938', '1939', '1945', '1941', 1, 'A második világháború előzménye.', 1),
(65, 'Ki volt a Szovjetunió utolsó vezetője?', 'Gorbacsov', 'Stalin', 'Kruscsov', 'Lenin', 1, 'A Szovjetunió felbomlásának idején.', 1),
(66, 'Melyik évben volt a normann hódítás Angliában?', '1066', '1215', '1492', '1302', 1, 'Az angol történelem fordulópontja.', 1),
(67, 'Melyik évben fedezte fel Kolumbusz Amerikát?', '1492', '1526', '1607', '1776', 1, 'A felfedezések kora kezdete.', 1),
(68, 'Melyik évben volt a berlini fal építése?', '1961', '1989', '1955', '1947', 1, 'A kelet-nyugati megosztottság szimbóluma.', 1),
(69, 'Ki volt a náci Németország légierő vezetője?', 'Hermann Göring', 'Joseph Goebbels', 'Heinrich Himmler', 'Albert Speer', 1, 'A Luftwaffe parancsnoka.', 1),
(70, 'Melyik évben volt a versailles-i békeszerződés?', '1919', '1945', '1938', '1923', 1, 'Az első világháború lezárása.', 1),
(71, 'Melyik évben volt a bécsi kongresszus?', '1815', '1848', '1789', '1914', 1, 'A napóleoni háborúk utáni rendezés.', 2),
(72, 'Ki volt a Habsburg-ház első magyar királya?', 'I. Ferdinánd', 'II. Lajos', 'IV. Béla', 'Szent István', 1, 'A Habsburg uralom kezdete Magyarországon.', 2),
(73, 'Melyik évben volt a trianoni békeszerződés?', '1920', '1919', '1945', '1938', 1, 'Magyarország területi veszteségeinek éve.', 2),
(74, 'Ki volt a magyar király az Anjou-házból?', 'Károly Róbert', 'Szent István', 'Hunyadi Mátyás', 'II. Lajos', 1, 'A gazdasági reformok királya.', 2),
(75, 'Melyik évben volt a berlini konferencia Afrika felosztásáról?', '1884', '1914', '1848', '1905', 1, 'A gyarmatosítás fontos állomása.', 2),
(76, 'Ki volt a francia forradalom radikális vezetője?', 'Robespierre', 'Napóleon', 'Danton', 'Marat', 1, 'A jakobinus diktatúra vezéralakja.', 2),
(77, 'Melyik évben volt a nagy októberi szocialista forradalom?', '1917', '1905', '1922', '1939', 1, 'A bolsevik hatalomátvétel éve.', 2),
(78, 'Ki volt a magyar király aki megalapította az egyetemet Pécsen?', 'Nagy Lajos', 'Szent István', 'Károly Róbert', 'Hunyadi Mátyás', 1, 'A magyar oktatás történetének mérföldköve.', 2),
(79, 'Melyik évben volt a Magna Carta kiadása?', '1215', '1066', '1492', '1302', 1, 'Az angol jog történetének mérföldköve.', 2),
(80, 'Melyik évben volt a reformáció kezdete?', '1517', '1492', '1618', '1302', 1, 'Luther Márton fellépésének éve.', 2),
(81, 'Ki volt a náci Németország hadseregének főparancsnoka?', 'Heinrich Himmler', 'Erwin Rommel', 'Adolf Hitler', 'Joseph Goebbels', 1, 'A Wehrmacht vezetője.', 2),
(82, 'Melyik évben volt a müncheni egyezmény?', '1938', '1939', '1945', '1941', 1, 'A második világháború előzménye.', 2),
(83, 'Ki volt a Szovjetunió utolsó vezetője?', 'Gorbacsov', 'Stalin', 'Kruscsov', 'Lenin', 1, 'A Szovjetunió felbomlásának idején.', 2),
(84, 'Melyik évben volt a normann hódítás Angliában?', '1066', '1215', '1492', '1302', 1, 'Az angol történelem fordulópontja.', 2),
(85, 'Melyik évben fedezte fel Kolumbusz Amerikát?', '1492', '1526', '1607', '1776', 1, 'A felfedezések kora kezdete.', 2),
(86, 'Melyik évben volt a berlini fal építése?', '1961', '1989', '1955', '1947', 1, 'A kelet-nyugati megosztottság szimbóluma.', 2),
(87, 'Ki volt a náci Németország légierő vezetője?', 'Hermann Göring', 'Joseph Goebbels', 'Heinrich Himmler', 'Albert Speer', 1, 'A Luftwaffe parancsnoka.', 2),
(88, 'Melyik évben volt a versailles-i békeszerződés?', '1919', '1945', '1938', '1923', 1, 'Az első világháború lezárása.', 2),
(89, 'Melyik évben volt a canossa-járás?', '1077', '1215', '800', '962', 1, 'A pápaság és császárság konfliktusának szimbóluma.', 2),
(90, 'Melyik évben volt a wormsi konkordátum?', '1122', '1077', '1215', '1302', 1, 'A pápaság és császárság közötti megegyezés.', 2),
(91, 'Melyik évben volt a rigómezei csata?', '1389', '1453', '1526', '1302', 1, 'A török terjeszkedés fontos állomása.', 2),
(92, 'Melyik évben volt a bécsi ostrom a törökök által?', '1683', '1526', '1606', '1711', 1, 'A Habsburg-török háborúk fordulópontja.', 2),
(93, 'Melyik évben volt a harmincéves háború kezdete?', '1618', '1648', '1606', '1588', 1, 'Európa egyik leghosszabb háborúja.', 2),
(94, 'Melyik béke zárta le a harmincéves háborút?', 'Vesztfáliai béke', 'Utrechti béke', 'Trianoni béke', 'Bécsi béke', 1, 'A vallási háborúk lezárása.', 2),
(95, 'Melyik évben volt a Szent Szövetség megalakulása?', '1815', '1792', '1848', '1871', 1, 'A napóleoni háborúk utáni rend fenntartása.', 2),
(96, 'Melyik évben volt a Tanácsköztársaság?', '1919', '1918', '1920', '1945', 1, 'A kommunista hatalomátvétel rövid időszaka.', 2),
(97, 'Melyik évben volt a második bécsi döntés?', '1940', '1938', '1941', '1939', 1, 'Magyarország területi visszacsatolása.', 2),
(98, 'Melyik évben volt a doni katasztrófa?', '1943', '1941', '1944', '1942', 1, 'A magyar hadsereg súlyos vesztesége.', 2),
(99, 'Melyik évben volt a párizsi békeszerződés?', '1947', '1945', '1956', '1939', 1, 'A második világháború utáni rendezés.', 2),
(100, 'Melyik évben volt a rendszerváltás Magyarországon?', '1989', '1990', '1985', '1991', 1, 'A kommunista rendszer bukása.', 2),
