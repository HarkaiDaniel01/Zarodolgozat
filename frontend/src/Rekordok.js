        ...
        return (
            ...
            <div>
                <div className="doboz">
                    ...
                    {adatok.length === 0 ? <div style={{textAlign:"center", fontWeight:"bold", margin:"20px"}}>Még senkinek sincs eredménye<br></br> Játsz és légy az első!</div> : <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                            <th>Helyezés</th>
                            <th>Játékos</th>
                        ...
                        <tbody>
                            {adatok.map((elem,index)=>(
                                ...
                                <tr className={elem.jatekos_id === jId ? "sorKijelolve" : "nincsKijeloles"}>
