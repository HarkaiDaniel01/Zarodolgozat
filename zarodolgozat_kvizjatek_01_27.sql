...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 27. 12:43
...
(127, 0, 0, 20, '2026-01-26 10:56:29', 10),
(128, 100000, 0, 20, '2026-01-26 10:58:18', 10),
(129, 0, 0, 20, '2026-01-26 10:58:37', 10),
(130, 0, 0, 20, '2026-01-26 11:05:25', 10),
...
--
ALTER TABLE `eredmenyek`
  MODIFY `Eredmenyek_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
...
--
ALTER TABLE `kategoria`
  MODIFY `kategoria_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT a táblához `kerdesek`
--
ALTER TABLE `kerdesek`
  MODIFY `kerdesek_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=639;
